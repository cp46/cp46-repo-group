---
title           : "Preregistration for the replication study of spatial range of the wingless grasshopper *Phaulacridium vittatum* using trait-based data and NicheMapR"
...
The calibration procedure employed to set up the weighing scale was erroneous and resulted in the recording of wrong wet weight values. Hence, the allometric model by [@bidauBreakingRuleMultiple2016] was used to generate wet weight values from the other morphometric parameters recorded. 
