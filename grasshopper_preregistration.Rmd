...
![Activity of Female Phaulacridium in Tasmania under zero shade. Inactivity from exceeding its maximum foraging temperature represents T_F Max, dropping below the minimum foraging temperature represents T_F Min.](output/phvi_F_body-temp_time.png)
