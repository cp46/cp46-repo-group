---
title           : "Preregistration for Replication Study of A test of the thermal melanism hypothesis in the wingless grass-hopper Phaulacridium vittatum "
...
```
Our study will feature a cross-sectional design, wherein we will evaluate the thermal properties in relation to melanism at a single point in time over a large spatial area. We will sample an equal number of individuals from different latitudes, and from within those latitudes, we will sample an equal number of individuals at different elevations. 
...
```
Insect samples will be collected from ... Climate data will be collected by ...

Laboratory tests for solar absorbtivity will be conducted by ...
...
```
We aim to collect 50 species per elevation at each site, and conduct transects at 6 sites. We plan to collect from 4 altitudinal gradients (< 100 m, 200–250 m, 400–450 m, and 700–800 m above sea level), resulting in a sample size of 1200 organisms. 
...
```
The above sample size was chosen for higher statistical power and due to personnel constraints in collecting field data. 
...
```
We manipulated altitudes by collecting organisms for certain sites. 
...
```
Solar absorbtivity (percentage), mass (grams), sex (male/female)
